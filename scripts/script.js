...
function displaydemands() {
  //prepare demand 1 text
  let demand1reward = []
  let demand1rewarddictionary = demandsingame[0]['concede']
  if ('hostage' in demand1rewarddictionary){
    demand1reward.push('Hostages Released: ' + demand1rewarddictionary['hostage'])
  }
  if ('freecard' in demand1rewarddictionary){
    demand1reward.push('Number of Free Cards: ' + demand1rewarddictionary['freecard'])
  }
  if ('dice' in demand1rewarddictionary){
    demand1reward.push('Extra Dice: ' + demand1rewarddictionary['dice'])
  }
  if ('threat' in demand1rewarddictionary){
    demand1reward.push('Threat Change: ' + demand1rewarddictionary['threat'])
  }
  let demand1penalty = []
  let demand1penaltydictionary = demandsingame[0]['penalty']
  if ('timeleft' in demand1penaltydictionary){
    demand1penalty.push('Abductor will escape at the end of the turn')
  }
  if ('dicepermanent' in demand1penaltydictionary){
    demand1penalty.push('1 Less Die Permanently')
  }
  if ('threatmultiplier' in demand1penaltydictionary){
    demand1penalty.push('Threat Increases are Doubled Permanently')
  }
  if ('threatincreaseperturn' in demand1penaltydictionary){
  ...
  let demand2reward = []
  let demand2rewarddictionary = demandsingame[1]['concede']
  if ('hostage' in demand2rewarddictionary){
    demand2reward.push('Hostages Released: ' + demand2rewarddictionary['hostage'])
  }
  if ('freecard' in demand2rewarddictionary){
    demand2reward.push('Number of Free Cards: ' + demand2rewarddictionary['freecard'])
  }
  if ('dice' in demand2rewarddictionary){
    demand2reward.push('Extra Dice: ' + demand2rewarddictionary['dice'])
  }
  if ('threat' in demand2rewarddictionary){
    demand2reward.push('Threat Change: ' + demand2rewarddictionary['threat'])
  }
  let demand2penalty = []
  let demand2penaltydictionary = demandsingame[1]['penalty']
  if ('timeleft' in demand2penaltydictionary){
    demand2penalty.push('Abductor will escape at the end of the turn')
  }
  if ('dicepermanent' in demand2penaltydictionary){
    demand2penalty.push('1 Less Die Permanently')
  }
  if ('threatmultiplier' in demand2penaltydictionary){
    demand2penalty.push('Threat Increases are Doubled Permanently')
  }
  if ('threatincreaseperturn' in demand2penaltydictionary){
    demand2penalty.push('Threat Increases by 2 Per Turn Permanently')
  }
  //input demand 2 text
